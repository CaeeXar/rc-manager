...
const Builds: NextPage<{ batteries: Battery[] }> = ({ batteries }) => {
  ...
  const [filteredBatteries, setFilteredBatteries] =
    useState<Battery[]>(batteries);
          ...
          <Table responsive>
            ...
            <tbody>
              {preparedBatteries.map((battery: Battery) => {
                return (
                  <tr key={battery.id} onClick={() => onShowHandler(battery)}>
                    <td>{battery.brand}</td>
                    <td>{battery.cells}</td>
              ...
              <ul className="list-unstyled">
                ...
                <li>
                  <Row>
                    ...
                    <Col>
                      <span>{getBatteryTypeText(selected.batteryType)}</span>
                    </Col>
                  </Row>
                </li>
                ...
                <li>
                  <Row>
                    ...
                    <Col>
                      <span>{getDatetimeLocal(selected.created)}</span>
                    </Col>
                  </Row>
                </li>
                ...
                <li>
                  <Row>
                    ...
                    <Col>
                      <span>
                        {(!!age.days ? age.days : age.months)?.toFixed()}
                      </span>
                    </Col>
                  </Row>
                </li>
