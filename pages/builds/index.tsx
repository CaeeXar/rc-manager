...
import { Button, Card, CloseButton, Col, Container, FormControl, InputGroup, Modal, Row, Table, Toast, ToastContainer } from 'react-bootstrap';
        ...
        <Container>
            ...
            {!!selected ?
                <Modal show={show} onHide={onCloseHandler} size='lg'>
                    <Modal.Header >
                        <Modal.Title><b>{selected.title}</b></Modal.Title>
