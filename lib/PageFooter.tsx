        ...
        <Row>
          <Col className="text-center" xs="12" sm="6" md="6" lg="4">
            ...
            <ul className="list-unstyled">
              <li>
                <NavLink
                  href="https://www.instagram.com/caeexar_fpv/"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <NavLink href="https://discord.gg/DTht8WpNEJ" target="_blank">
                  <span className="icon-spacer">
          ...
          <Col className="text-center" xs="12" sm="6" md="6" lg="4">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <NavLink href="http://192.168.178.33:3000/" target="_blank">
                  <span className="icon-spacer">
          ...
          <Col xs="12" sm="12" md="12" lg="3">
            <span className="text-uppercase h5 w-100" style={{ float: "left" }}>
              Fly safe!
            </span>
